# NODE 20 base image for DEVELOPER
FROM debian:bookworm-slim

LABEL maintainer="Equipo de Arquitectura y Seguridad <arquitectura@empresa.com>"
LABEL version="1.0.1"
LABEL description="Imagen base corporativa DEV para Node.js 20 sobre Debian Slim"
...
RUN npm install -g yarn@1.22.19 pnpm@10 && npm cache clean --force
