...
#### Construye
```
docker build -t localhost:5000/base/node16-dev-debian:1.0.0 .
```
...
```
docker push localhost:5000/base/node16-dev-debian:1.0.0
```
...
#### Construye runtime
```
docker build -t localhost:5000/base/node16-runtime-debian:1.0.0 .
```

#### Pushea al registry

```
docker push localhost:5000/base/node16-runtime-debian:1.0.0
```
